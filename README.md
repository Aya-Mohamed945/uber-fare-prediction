...
| pickup\_longitude  | Pickup longitude coordinate  |

| pickup\_latitude   | Pickup latitude coordinate   |

| dropoff\_longitude | Dropoff longitude coordinate |

| dropoff\_latitude  | Dropoff latitude coordinate  |

| passenger\_count   | Number of passengers         |

| pickup\_datetime   | Date and time of trip pickup |

| fare\_amount       | Trip fare (Target Variable)  |
...
\* Latitude Difference (`lat\_diff`)

\* Longitude Difference (`lon\_diff`)
